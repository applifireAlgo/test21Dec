...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/VTM8AJ3LPKLAHECJXAYYWW/3F2A18EA-3331-4898-9AEC-1ECE977B4791/art/data
AST_DATA_PATH=/tmp/applifire/db/VTM8AJ3LPKLAHECJXAYYWW/3F2A18EA-3331-4898-9AEC-1ECE977B4791/ast/data
DB_NAME=applifire
USER=root
PASSWORD=Glass4#21
PORT=3306
...
MYSQL=/usr/bin
PROJECT_ID=VTM8AJ3LPKLAHECJXAYYWW
