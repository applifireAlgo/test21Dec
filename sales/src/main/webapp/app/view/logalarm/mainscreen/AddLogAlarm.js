 ...
 * 
 */
Ext.define('Sales.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Sales.view.logalarm.mainscreen.AddLogAlarmController',
			'Sales.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Sales.view.logalarm.mainscreen.AppAlarmPanel',
