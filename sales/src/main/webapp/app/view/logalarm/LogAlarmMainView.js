 ...
 * 
 */
Ext.define('Sales.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Sales.view.logalarm.LogAlarmMainViewController',
			'Sales.view.logalarm.tree.LogAlarmTreePanel',
			'Sales.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
