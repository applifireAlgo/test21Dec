Ext.define('Sales.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Sales.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Sales.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Sales.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Sales.view.querybuildernewmodel.querydetail.QueryDetail');
