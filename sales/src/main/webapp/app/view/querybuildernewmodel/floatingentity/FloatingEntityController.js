Ext.define('Sales.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Sales.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Sales.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Sales.view.querybuildernewmodel.floatingentity.EntitySprite',
