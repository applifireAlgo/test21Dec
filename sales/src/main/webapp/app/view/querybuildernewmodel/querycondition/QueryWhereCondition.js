Ext.define('Sales.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Sales.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
