Ext.define('Sales.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Sales.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
