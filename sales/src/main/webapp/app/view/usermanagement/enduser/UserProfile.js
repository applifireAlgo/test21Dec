Ext.define('Sales.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Sales.view.usermanagement.enduser.UserProfileController', 'Sales.view.usermanagement.admin.AddUserDetailsViewModel', 'Sales.model.AddUserDataModel' ],
