Ext.define('Sales.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Sales.view.reportui.datachart.chart.RatingField','Sales.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
