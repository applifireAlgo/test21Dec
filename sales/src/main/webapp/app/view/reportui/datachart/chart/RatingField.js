...
Ext.define('Sales.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Sales.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Sales.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
