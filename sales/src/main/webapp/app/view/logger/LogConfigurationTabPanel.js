...
Ext
		.define(
				'Sales.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Sales.view.logger.tabs.details.DetailsTab',
							'Sales.view.logger.tabs.fileconnector.FileConnectorTab',
							'Sales.view.logger.tabs.dbconnector.DBConnectorTab',
							'Sales.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Sales.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Sales.view.logger.LogConfigurationTabPanelController',
