 ...
 * 
 */
Ext.define('Sales.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Sales.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
