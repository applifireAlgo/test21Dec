Ext
		.define(
				'Sales.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Sales.view.searchengine.search.SearchEngineMainPanelController','Sales.view.searchengine.search.PanelHeaderField' ,'Sales.view.searchengine.search.ReportGridView','Sales.view.searchengine.search.ReportChartView','Sales.view.searchengine.search.documentView','Sales.view.searchengine.search.DouMeanView','Sales.view.googlemaps.map.MapPanel'],
