Ext.define('Sales.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Sales.view.searchengine.search.NorthPanel', 'Sales.view.searchengine.search.SearchResult','Sales.view.searchengine.search.SearchEngineMainPanelController'],
