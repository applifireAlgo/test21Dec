Ext.define('Sales.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Sales.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Sales.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Sales.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Sales.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
