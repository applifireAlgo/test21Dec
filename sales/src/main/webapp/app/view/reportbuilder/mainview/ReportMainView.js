Ext.define('Sales.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Sales.view.reportbuilder.reportlist.ReportListPanelView',
             'Sales.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Sales.view.reportbuilder.mainview.ReportMainController'
             ],
