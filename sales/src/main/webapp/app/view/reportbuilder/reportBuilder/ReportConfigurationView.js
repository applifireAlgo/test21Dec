Ext.define('Sales.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Sales.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Sales.view.reportbuilder.gridconfig.GridConfigView',
	           'Sales.view.reportbuilder.properties.PropertiesPanelView',
	           'Sales.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
