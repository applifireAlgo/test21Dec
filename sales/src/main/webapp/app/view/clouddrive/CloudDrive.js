Ext.define("Sales.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Sales.view.clouddrive.CloudDriveController',
	             'Sales.view.clouddrive.documentview.DocumentsView',
	             'Sales.view.clouddrive.drivedetails.DriveDetails',
	             //'Sales.view.clouddrive.documentview.DocumentListView'
	             ],
