 ...
 * 
 */
Ext.define('Sales.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Sales.view.securityconfig.SecurityConfigController',
			'Sales.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
