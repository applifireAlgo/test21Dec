Ext.define('Sales.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Sales.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Sales.view.console.ConsoleWindow');
