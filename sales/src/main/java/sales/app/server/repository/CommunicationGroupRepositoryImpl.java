...
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<sales.app.shared.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                sales.app.shared.contacts.CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            sales.app.shared.contacts.CommunicationGroup s = emanager.find(sales.app.shared.contacts.CommunicationGroup.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            sales.app.shared.contacts.CommunicationGroup listOfCommunicationGroup = (sales.app.shared.contacts.CommunicationGroup) query.getSingleResult();
