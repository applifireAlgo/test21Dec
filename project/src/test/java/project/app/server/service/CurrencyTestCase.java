...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("6RVhDEwI7zAZfXq9peEHv8hW1lMKlkIh");
            country.setCapitalLatitude(8);
            country.setCapitalLongitude(5);
            country.setCountryCode1("co6");
            country.setCountryCode2("LUz");
            country.setCountryFlag("YCjZ5TCfgQJtvsdGuZKxI0Y7t8K1v2GsoVcb4w6HsU826nT5Yq");
            country.setCountryName("9Ai6iFbVCxR8YH1GEp4jwymMaEoXJZCZUvELKYFfXcKS1AdnGq");
            country.setCurrencyCode("Uni");
            country.setCurrencyName("8eOLjpHq44B6LdvmQ2H9NubZr4COdsHyf06oen1l6Y0aB4Lhvp");
            country.setCurrencySymbol("4xNytv4h3HzxohjbvZz37HEXW2THeVBV");
            country.setIsoNumeric(8);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("av8ipze8SopnaMwXzz1ayBQy0bsk2ngHTpPzy8laM1BZpqHmUe");
            currency.setUnicodeDecimal("YgpKG1iM50mxfLlq4KByRdw640sAU3Jnsi7B2aizbqL68HRqIf");
            currency.setUnicodeHex("USi3bx3y4O96Ew0ZbI6aB27fBGdznUtfCBEv5AnSsFI3FFULrr");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("gD1nHzNPIER1mikAM5a79Wrtveb6LW6VeDOsOW40JtwraderqY");
            currency.setUnicodeDecimal("eqOAFTfFygvRDrl7LL7xyobZ8wfwKMgRultddcSYELeRcWzWIO");
            currency.setUnicodeHex("N5GMAx1cyyvEyoNQqq24dWHEb0uk8Anw1YhNIuMnIE3Ke9k2iQ");
