Ext.define('Onlineshopapp.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Onlineshopapp.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Onlineshopapp.view.reportbuilder.gridconfig.GridConfigView',
	           'Onlineshopapp.view.reportbuilder.properties.PropertiesPanelView',
	           'Onlineshopapp.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
