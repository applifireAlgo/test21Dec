Ext.define('Onlineshopapp.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopapp.view.reportbuilder.properties.RptDrillDownGridController'],
