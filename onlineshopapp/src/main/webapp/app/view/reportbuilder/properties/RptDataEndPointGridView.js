Ext.define('Onlineshopapp.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopapp.view.reportbuilder.properties.RptDataEndPointGridController'],
