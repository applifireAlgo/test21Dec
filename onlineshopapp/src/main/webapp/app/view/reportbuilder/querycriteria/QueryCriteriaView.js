Ext.define('Onlineshopapp.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopapp.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Onlineshopapp.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Onlineshopapp.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Onlineshopapp.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
