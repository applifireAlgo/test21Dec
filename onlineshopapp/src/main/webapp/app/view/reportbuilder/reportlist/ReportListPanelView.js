Ext.define('Onlineshopapp.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Onlineshopapp.view.reportbuilder.reportlist.ReportListPanelController'],
