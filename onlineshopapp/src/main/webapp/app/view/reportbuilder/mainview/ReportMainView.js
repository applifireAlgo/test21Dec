Ext.define('Onlineshopapp.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Onlineshopapp.view.reportbuilder.reportlist.ReportListPanelView',
             'Onlineshopapp.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Onlineshopapp.view.reportbuilder.mainview.ReportMainController'
             ],
