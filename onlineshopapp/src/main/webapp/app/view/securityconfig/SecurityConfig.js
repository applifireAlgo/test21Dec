 ...
 * 
 */
Ext.define('Onlineshopapp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Onlineshopapp.view.securityconfig.SecurityConfigController',
			'Onlineshopapp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
