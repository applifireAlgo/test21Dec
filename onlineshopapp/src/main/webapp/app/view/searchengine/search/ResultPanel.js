Ext
		.define(
				'Onlineshopapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Onlineshopapp.view.searchengine.search.SearchEngineMainPanelController','Onlineshopapp.view.searchengine.search.PanelHeaderField' ,'Onlineshopapp.view.searchengine.search.ReportGridView','Onlineshopapp.view.searchengine.search.ReportChartView','Onlineshopapp.view.searchengine.search.documentView','Onlineshopapp.view.searchengine.search.DouMeanView','Onlineshopapp.view.googlemaps.map.MapPanel'],
