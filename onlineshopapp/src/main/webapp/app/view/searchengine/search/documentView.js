Ext
		.define(
				'Onlineshopapp.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Onlineshopapp.view.searchengine.search.documentController',
							'Onlineshopapp.view.searchengine.search.RowExpander' ],
