 ...
 * 
 */
Ext.define('Onlineshopapp.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Onlineshopapp.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Onlineshopapp.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
