Ext.define('Onlineshopapp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Onlineshopapp.view.usermanagement.admin.UserPasswordReset',
	            'Onlineshopapp.view.usermanagement.admin.AddUserDetails',
	            'Onlineshopapp.view.usermanagement.admin.ViewUser'],
