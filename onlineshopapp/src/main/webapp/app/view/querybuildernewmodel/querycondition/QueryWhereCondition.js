Ext.define('Onlineshopapp.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Onlineshopapp.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
