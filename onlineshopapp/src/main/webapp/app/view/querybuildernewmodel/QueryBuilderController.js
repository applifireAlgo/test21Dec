Ext.define('Onlineshopapp.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Onlineshopapp.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Onlineshopapp.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Onlineshopapp.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Onlineshopapp.view.querybuildernewmodel.querydetail.QueryDetail');
