Ext.define('Onlineshopapp.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Onlineshopapp.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Onlineshopapp.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Onlineshopapp.view.querybuildernewmodel.floatingentity.EntitySprite',
