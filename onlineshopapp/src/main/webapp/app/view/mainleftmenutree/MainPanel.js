Ext.define('Onlineshopapp.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Onlineshopapp.view.resource.ResourcePanel',
			'Onlineshopapp.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Onlineshopapp.view.resource.DockedResourcePanel','Onlineshopapp.view.fw.mainViewPanel.MainPanelController' ],
