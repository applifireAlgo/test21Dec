 ...
 * 
 */
Ext.define('Onlineshopapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Onlineshopapp.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
