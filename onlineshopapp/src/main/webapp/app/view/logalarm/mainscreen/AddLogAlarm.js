 ...
 * 
 */
Ext.define('Onlineshopapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Onlineshopapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Onlineshopapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Onlineshopapp.view.logalarm.mainscreen.AppAlarmPanel',
