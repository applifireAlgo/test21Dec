 ...
 */
Ext.define('Onlineshopapp.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Onlineshopapp.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Onlineshopapp.view.fw.component.DateTimePicker(o);
    },
