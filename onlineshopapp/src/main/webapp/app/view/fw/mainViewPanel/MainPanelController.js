Ext.define('Onlineshopapp.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Onlineshopapp.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Onlineshopapp.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
