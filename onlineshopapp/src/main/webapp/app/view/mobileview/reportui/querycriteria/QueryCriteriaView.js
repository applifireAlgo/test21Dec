Ext
		.define(
				'Onlineshopapp.view.mobileview.reportui.querycriteria.QueryCriteriaView',
				{
					extend : 'Ext.panel.Panel',
					requires : [ 'Onlineshopapp.view.mobileview.reportui.querycriteria.QueryCriteriaController' ],
					xtype : 'querycriteria',
