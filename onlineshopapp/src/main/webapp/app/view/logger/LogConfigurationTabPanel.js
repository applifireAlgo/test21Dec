...
Ext
		.define(
				'Onlineshopapp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Onlineshopapp.view.logger.tabs.details.DetailsTab',
							'Onlineshopapp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Onlineshopapp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Onlineshopapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Onlineshopapp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Onlineshopapp.view.logger.LogConfigurationTabPanelController',
