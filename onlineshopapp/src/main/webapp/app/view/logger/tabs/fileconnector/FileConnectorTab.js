 ...
 * 
 */
Ext.define('Onlineshopapp.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Onlineshopapp.view.logger.tabs.fileconnector.FileConnectorTabController'],
