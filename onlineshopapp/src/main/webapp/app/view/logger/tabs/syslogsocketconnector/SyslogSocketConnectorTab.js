 ...
 * 
 */
Ext.define('Onlineshopapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Onlineshopapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
