Ext.define('Onlineshopapp.view.chartbuilder.chartjsonsource.ChartJsonSourceView', {
	
	extend : 'Ext.panel.Panel',
	requires : [ 'Ext.layout.container.Column',
	             'Onlineshopapp.view.chartbuilder.chartjsonsource.ChartJsonSourceController'
	           ],
	xtype : 'source-view',
	itemId:'sourceView',
