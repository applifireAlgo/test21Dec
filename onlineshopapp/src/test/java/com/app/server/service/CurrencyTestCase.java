...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("Q6dELsaQLwbTwNih7EqUYL3m77j1pL0M");
            country.setCapitalLatitude(10);
            country.setCapitalLongitude(4);
            country.setCountryCode1("Wvr");
            country.setCountryCode2("JGx");
            country.setCountryFlag("MZ4OIRAxNwkcTDdCZn0IiIYUS9gaB3LEOxBsAb2HOMfzmD2D5r");
            country.setCountryName("yHzWNagpQdQCoIn60AwATdnzRQytEQqNFJAKKKZe3NLp2SflFT");
            country.setCurrencyCode("5kR");
            country.setCurrencyName("PilMBxPVg8fzQb7lXKc1jzVNEOWJVfSPjMB9N0qV5oxPaXs1yT");
            country.setCurrencySymbol("PdgEohBJL0XOFFRC3mRnwhnHrMGjRwON");
            country.setIsoNumeric(8);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("vhIKvlL5TNknhSl6n2WuEqWSDQMgkUvUIUCO3vZW68dSHY9MYE");
            currency.setUnicodeDecimal("XG57YQYaSqUXgiVje3aspKampgAw04866GuheUWC1nsZfSaiA2");
            currency.setUnicodeHex("z0E3XPowM0YVhhGjOfEDCp8KfbY63Vit1GvwHgxoMZNEE01ftO");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("SyIDbBC1LzFUTYy04870lxHhMdbHVqiSYEOxmFxXepoj1FdDLj");
            currency.setUnicodeDecimal("CtDBObMekkKwoxIPhXF13MeU0gF9JgfJ0kCnDGnjHVIvH6ToDD");
            currency.setUnicodeHex("bVF9xTOzdDGmPrZkWzpvQvB6GZzZZSItxgbLvjyKJwVqnkF7QU");
